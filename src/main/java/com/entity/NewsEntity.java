...
public class NewsEntity<T> implements Serializable {
     ...
     * 民宿标题
     */
    @ColumnInfo(comment="民宿标题",type="varchar(200)")
     ...
     * 民宿类型
     */
    @ColumnInfo(comment="民宿类型",type="int(11)")
     ...
     * 民宿图片
     */
    @ColumnInfo(comment="民宿图片",type="varchar(200)")
     ...
     * 民宿详情
     */
    @ColumnInfo(comment="民宿详情",type="longtext")
