    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="民宿标题" prop="newsName">
                       <el-input v-model="ruleForm.newsName"
                                 placeholder="民宿标题" clearable  :readonly="ro.newsName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="民宿标题" prop="newsName">
                           <el-input v-model="ruleForm.newsName"
                                     placeholder="民宿标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="民宿类型" prop="newsTypes">
                        <el-select v-model="ruleForm.newsTypes" :disabled="ro.newsTypes" placeholder="请选择民宿类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="民宿类型" prop="newsValue">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.newsPhoto" label="民宿图片" prop="newsPhoto">
                        <file-upload
                            tip="点击上传民宿图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.newsPhoto" label="民宿图片" prop="newsPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.newsContent"  label="民宿详情" prop="newsContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.newsContent" label="民宿详情" prop="newsContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   newsName: [
                              { required: true, message: '民宿标题不能为空', trigger: 'blur' },
                          ],
                   newsTypes: [
                   ...
                   newsContent: [
                              { required: true, message: '民宿详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
