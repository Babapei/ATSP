    ...
    <div class="main-content">
        <el-dialog title="帖子回复详情" :visible.sync="forumReplyDialogVisible">
            ...
            <div class="demo-input-suffix">
                <span style="width: 20%">租车标题：</span><el-input v-model="forumTitle" :disabled="true" placeholder="租车标题" style="width: 80%"></el-input>
            </div>
            <div class="demo-input-suffix">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '租车标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.forumName" placeholder="租车标题" clearable></el-input>
                     </el-form-item>
    ...
    <!--                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum','查看')" type="primary" icon="el-icon-edit" size="mini" @click="openReplyForum(scope.row.id,scope.row.forumName,scope.row.forumContent)">查看租车回复</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            forumReplyDialogVisible : false,//租车回复模态框
            forumReplyInfoDialogVisible : false,//租车回复详情模态框
            superIds : "",//帖子id
            forumTitle : "",//租车标题
            forumContent : "",//帖子内容
        ...
        methods: {
            ...
            // 当前帖子相关 end
                ...
                _this.forumReplyDialogVisible = true;//租车回复模态框
                _this.forumReplyInfoDialogVisible = false;//租车回复详情模态框
            ...
            seeForumContent(forumContent) {
                ...
                _this.forumReplyInfoDialogVisible = true;//租车回复详情模态框
            },
            // 删除数据
            deleteForumData(id){
                let _this = this;
