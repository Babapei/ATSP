        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '民宿标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.newsName" placeholder="民宿标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '民宿类型' : ''">
                        <el-select v-model="searchForm.newsTypes" placeholder="请选择民宿类型">
