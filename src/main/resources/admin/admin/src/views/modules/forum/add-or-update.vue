    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="租车标题" prop="forumName">
                        <el-input v-model="ruleForm.forumName"
                                  placeholder="租车标题" clearable  :readonly="ro.forumName"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="租车标题" prop="forumName">
                            <el-input v-model="ruleForm.forumName"
                                      placeholder="租车标题" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   forumName: [
                              { required: true, message: '租车标题不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
